...
//                   {renderBackArrow()}
//                   <InvestTabPane onClick={handleTabClick} />
...
//                                 class="starter-plan"
//                               >
//                                 Starter Plan 2.5% ROI, 7 DAYS PACKAGE
//                                 $100-$10000
//                               </Link>
//                               <Link
...
//                                 class="starter-plan"
//                               >
//                                 Starter Plan 3.0% ROI, 10 DAYS PACKAGE
//                                 $300-$15000
//                               </Link>
//                               <Link
...
//                                 class="master-plan"
//                               >
//                                 Master Plan 4.0% ROI, 30 DAYS PACKAGE
//                                 $101000-$UNLIMITED
//                               </Link>
//                             </div>
//                           </div>
                  ...
                  <div class="invest-wt-caltex">
                    ...
                    <div class="forex-or-crypto">
                      <div class="forex-or-crypto-inner">
                        <span class="forex" id="forex" onClick={checkForexPlan}>
                          Forex
                        </span>
                        <span
                          class="crypto"
                          id="crypto"
                          onClick={checkCryptoPlan}
                        >
                          Crypto
                        </span>
                      </div>
                      ...
                      <div class="choose-your-plan">
                        <div class="choose">
                          ...
                          <div class="plan-options-forex" id="plan-forex">
                            <div class="plan">
                              <Link
                                to="/ForexDetails/StarterplanForex"
                                class="starter-plan"
                              >
                                Starter Plan 2.5% ROI, 7 DAYS PACKAGE
                                $100-$10000
                              ...
                              <Link
                                to="/ForexDetails/professionalplanForex"
                                class="professional-plan"
                              >
                                Professional Plan 2.5% ROI, 14 DAYS PACKAGE
                                $11000-$50000
                              ...
                              <Link
                                to="/ForexDetails/masterplanForex"
                                class="master-plan"
                              >
                                Master Plan 2.5% ROI, 21 DAYS PACKAGE
                                $50000-$100000
                          ...
                          <div class="plan-options-crypto" id="plan-crypto">
                            <div class="plan">
                              <Link
                                to="/CryptoDetails/starterplanCrypto"
                                class="starter-plan"
                              >
                                Starter Plan 3.0% ROI, 10 DAYS PACKAGE
                                $300-$15000
                              ...
                              <Link
                                to="/CryptoDetails/professionalplanCrypto"
                                class="professional-plan"
                              >
                                Professional Plan 3.5% ROI, 20 DAYS PACKAGE
                                $16000-$100000
                              ...
                              <Link
                                to="/CryptoDetails/masterplanCrypto"
                                class="master-plan"
                              >
                                Master Plan 4.0% ROI, 30 DAYS PACKAGE
                                $101000-$UNLIMITED

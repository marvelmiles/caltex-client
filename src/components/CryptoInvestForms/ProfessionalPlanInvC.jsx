...
const ProfessionalPlanInvC = () => {
  ...
  const [plan, setPlan] = useState("professionalPlan");
            ...
            <div class="invest-wt-caltexF">
              ...
              <div class="forex-or-crypto">
                <div class="forex-or-crypto-inner">
                  <Link to="/Invest/InvestPage" class="forex" id="forexC">
                    Forex
                  </Link>
                  <span class="crypto" id="cryptoC">
                    Crypto
                  </span>
                </div>
              </div>
            ...
            <div class="professional-planInvestC">
              <form onSubmit={handleSubmit}>
                ...
                <div class="invest-starter-btn">
                  <button class="invest-starter" onclick="congrat()">
                    Invest
                  </button>
                </div>
              </form>
